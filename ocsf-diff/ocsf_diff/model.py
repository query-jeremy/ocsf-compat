...
@dataclass
class DiffVersion(Difference[OcsfVersion]):
    version: Difference[str] = field(default_factory=NoChange[str])


@dataclass
class DiffEnumMember(Difference[OcsfEnumMember]):
    caption: Difference[str] = field(default_factory=NoChange[str])
    description: Difference[Optional[str]] = field(
        default_factory=NoChange[Optional[str]]
    )
...
class DiffAttr(Difference[OcsfAttr]):
    ...
    enum: Difference[Optional[OcsfEnum]] = field(
        default_factory=NoChange[Optional[OcsfEnum]]
    )
    group: Difference[Optional[str]] = field(default_factory=NoChange[Optional[str]])
    is_array: Difference[Optional[bool]] = field(
        default_factory=NoChange[Optional[bool]]
    )
    ...
    notes: Difference[Optional[str]] = field(default_factory=NoChange[Optional[str]])
    observable: Difference[Optional[int]] = field(
        default_factory=NoChange[Optional[int]]
    )
    range: Difference[Optional[list[int]]] = field(
        default_factory=NoChange[Optional[list[int]]]
    )
    regex: Difference[Optional[str]] = field(default_factory=NoChange[Optional[str]])
    requirement: Difference[Optional[str]] = field(
        default_factory=NoChange[Optional[str]]
    )
    ...
    type_name: Difference[Optional[str]] = field(
        default_factory=NoChange[Optional[str]]
    )
    profile: Difference[Optional[str | list[str]]] = field(
        default_factory=NoChange[Optional[str | list[str]]]
    )
    values: Difference[Optional[list[Any]]] = field(
        default_factory=NoChange[Optional[list[Any]]]
    )
...
@dataclass
class DiffExtension(Difference[OcsfExtension]):
...
@dataclass
class DiffDictionaryTypes(Difference[OcsfDictionaryTypes]):
...
@dataclass
class DiffDictionary(Difference[OcsfDictionary]):
    attributes: DiffAttributes = field(default_factory=dict)
    caption: Difference[str] = field(default_factory=NoChange[str])
    description: Difference[str] = field(default_factory=NoChange[str])
    name: Difference[str] = field(default_factory=NoChange[str])
    types: Difference[OcsfDictionaryTypes] = field(
        default_factory=NoChange[OcsfDictionaryTypes]
    )


@dataclass
class DiffCategory(Difference[OcsfCategory]):
    caption: Difference[str] = field(default_factory=NoChange[str])
    description: Difference[str] = field(default_factory=NoChange[str])
    uid: Difference[int] = field(default_factory=NoChange[int])
    type: Difference[Optional[str]] = field(default_factory=NoChange[Optional[str]])
...
@dataclass
class DiffCategories(Difference[OcsfCategories]):
...
@dataclass
class DiffInclude(Difference[OcsfInclude]):
    caption: Difference[str] = field(default_factory=NoChange[str])
    attributes: DiffAttributes = field(default_factory=dict)
    description: Difference[Optional[str]] = field(
        default_factory=NoChange[Optional[str]]
    )
    annotations: Difference[dict[str, str]] = field(
        default_factory=NoChange[dict[str, str]]
    )


@dataclass
class DiffProfile(Difference[OcsfProfile]):
    caption: Difference[str] = field(default_factory=NoChange[str])
    description: Difference[str] = field(default_factory=NoChange[str])
...
@dataclass
class DiffObject(Difference[OcsfObject]):
    caption: Difference[str] = field(default_factory=NoChange[str])
    ...
    profiles: Difference[Optional[list[str]]] = field(
        default_factory=NoChange[Optional[list[str]]]
    )
    constraints: Difference[Optional[dict[str, list[str]]]] = field(
        default_factory=NoChange[Optional[dict[str, list[str]]]]
    )
    include: Difference[Optional[str | list[str]]] = field(
        default_factory=NoChange[Optional[str | list[str]]]
    )
    deprecated: Difference[Optional[OcsfDeprecationInfo]] = field(
        default_factory=NoChange[Optional[OcsfDeprecationInfo]]
...
@dataclass
class DiffEvent(Difference[OcsfEvent]):
    caption: Difference[str] = field(default_factory=NoChange[str])
    name: Difference[str] = field(default_factory=NoChange[str])
    attributes: DiffAttributes = field(default_factory=dict)
    description: Difference[Optional[str]] = field(
    ...
    associations: Difference[dict[str, list[str]]] = field(
        default_factory=NoChange[dict[str, list[str]]]
    )
    constraints: Difference[dict[str, list[str]]] = field(
        default_factory=NoChange[dict[str, list[str]]]
    )
    include: Difference[Optional[str]] = field(default_factory=NoChange[Optional[str]])
    deprecated: Difference[Optional[OcsfDeprecationInfo]] = field(
...
@dataclass
class DiffSchema(Difference[OcsfSchema]):
    ...
    base_event: Difference[Optional[OcsfEvent]] = field(
        default_factory=NoChange[Optional[OcsfEvent]]
    )
...
# OcsfComparable = OcsfSchema | OcsfEvent | OcsfObject | OcsfAttr | OcsfDeprecationInfo | OcsfDictionary | OcsfCategories | OcsfInclude | OcsfProfile | OcsfExtension | OcsfVersion | OcsfEnumMember
